 ...
 */
class FilelinksViewFiles extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_FILELINKS_TITLE_FILES'), 'files.png');

		//Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/editfiledetails';
		if (file_exists($formPath))
		{

			if ($canDo->get('core.create'))
			{
				JToolBarHelper::addNew('editfiledetails.add', 'JTOOLBAR_NEW');
			}

			if ($canDo->get('core.edit') && isset($this->items[0]))
			{
				JToolBarHelper::editList('editfiledetails.edit', 'JTOOLBAR_EDIT');
			}
