...
<h1 style="margin-left:0">Filelinks Content plugin</h1>

<p>Please make sure you have the <strong>Filelinks Component</strong> installed first</p>
...
<p>Should the link open in a new window or the current window</p>

<h3>Add description</h3>

<p>Add the description of the item after the link</p>
...
<p>The default path for the css is <span class="typewriterb">plugins/content/filelinks/filelinks.css</span> but you can change this to point to your customised version so it doesn't get overwritten on plugin update.</p>

<h2>Catlist options</h2>

<h3>List style</h3>

<p>choices are <strong>ul</strong> - unordered list with bullets or <strong>ol</strong> - ordered list with numbers
</p><img src="<?php echo JURI::root();?>media/com_filelinks/help/ul.jpg" alt="unordered list" title="unordered list" />

<h3>Ordering</h3>

<p>The order in which the links are output</p>
...
<p>If you choose this option then instead of using the inbuilt list style for output the markup is with a dl (definition list)
...
<p>would also work but when you are looking at an article in article manager it is much easier to work out what the link is for with the title added.</p>
...
<p>options are all set in the filelinks plugin - you can however edit the category name if you want to output a different heading. Taking the example above we could edit it to read:</p>
