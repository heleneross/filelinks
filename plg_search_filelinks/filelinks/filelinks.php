...
/**
 * Filelinks Search plugin modified for BFGnet
 *
 * @package        Joomla.Plugin
 * @subpackage     Search.filelinks
 * @since          1.6
 */
class plgSearchFilelinks extends JPlugin
{
	/**
	 * Constructor
	 *
	...
	function onContentSearch($text, $phrase = '', $ordering = '', $areas = null)
	{
		...
		$section = JText::_('PLG_SEARCH_FILELINKS_WEBLINKS');
